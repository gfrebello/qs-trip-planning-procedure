...
public class HotelRoomResource {
    ...
    @Timed
    public ResponseEntity<HotelRoom> createHotelRoom(@RequestBody HotelRoom hotelRoom) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<HotelRoom> updateHotelRoom(@RequestBody HotelRoom hotelRoom) throws URISyntaxException {

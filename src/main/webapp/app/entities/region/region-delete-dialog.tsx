...
export interface IRegionDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="tripPlanningApp.region.delete.question">
          <Translate contentKey="tripPlanningApp.region.delete.question" interpolate={{ id: regionEntity.id }}>

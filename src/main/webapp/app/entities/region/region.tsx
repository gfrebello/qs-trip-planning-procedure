    ...
    return (
      <div>
        <h2 id="region-heading">
          <Translate contentKey="tripPlanningApp.region.home.title">Regions</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="tripPlanningApp.region.home.createLabel">Create new Region</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="tripPlanningApp.region.regionName">Region Name</Translate>
                </th>
                <th />
              </tr>
            </thead>

...
export interface ITicketDetailProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="tripPlanningApp.ticket.detail.title">Ticket</Translate> [<b>{ticketEntity.id}</b>]
          </h2>

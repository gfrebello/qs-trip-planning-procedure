...
export class PaymentUpdate extends React.Component<IPaymentUpdateProps, IPaymentUpdateState> {
  ...
  render() {
    const { paymentEntity, trips, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="tripPlanningApp.payment.home.createOrEditLabel">
              <Translate contentKey="tripPlanningApp.payment.home.createOrEditLabel">Create or edit a Payment</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : paymentEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="amountLabel" for="amount">
                    <Translate contentKey="tripPlanningApp.payment.amount">Amount</Translate>
                  </Label>
                  <AvField id="payment-amount" type="number" className="form-control" name="amount" />
                </AvGroup>
